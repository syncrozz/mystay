...
export const PlanBoard: React.FC<PlanBoardProps> = ({
  ...
  return (
    <div id="plan-board-view" className="space-y-4 max-w-6xl mx-auto">
      ...
      {/* 1. Header & Context */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white rounded-2xl border border-slate-200 shadow-2xs p-4 sm:p-5">
        <div>
          <h1 className="text-sm font-black text-slate-900 uppercase tracking-wider">
            Perancangan
          </h1>
          <p className="text-xs text-slate-500 mt-0.5 font-medium">
            {totalItems} aktiviti ({wajibCount} Wajib, {optionalCount} Pilihan, {backlogCount} Belum Dijadual)
          </p>
        </div>
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 px-3.5 py-2 bg-teal-600 hover:bg-teal-700 active:scale-95 text-white text-xs font-bold rounded-xl shadow-xs transition-all cursor-pointer"
          >
      ...
      {/* 2. Fast Frictionless Direct Input */}
